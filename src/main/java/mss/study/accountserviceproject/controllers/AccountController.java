package mss.study.accountserviceproject.controllers;

import mss.study.accountserviceproject.pojos.Account;
import mss.study.accountserviceproject.services.AccountService;
...
public class AccountController {
    ...
    public ResponseEntity<List<Account>> findByRoleName(@PathVariable String roleName) {
        List<Account> accounts = accountService.findByRoleRoleName(roleName);
        return ResponseEntity.ok(accounts);
    }
